...
/**
 * @title DungeonCharacterFactory
 * @author Maikel Ordaz
 * @notice This contract make the calls to the VRF Consumer
 */
...
contract DungeonCharacterFactory is VRFConsumerBaseV2, DungeonHelper, ERC721URIStorage {
    //////////////////////////
    // Chainlink variables //
    ////////////////////////
     ...
     */
    function requestRandomCharacter(string memory name) internal returns (uint256 requestId) {
